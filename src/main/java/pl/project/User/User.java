...
public class User {
    ...
    public User(int id, String name, String lastname, String degree, String email, String department, String major,  String password, String login, String role, Boolean enabled) {
        this.id = id;
        this.name = name;
